        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton('Add Your Group 🤗', url='https://t.me/EM_Song_Bot?startgroup=true')
                ],
                [
...
def a(client, message):
    ...
    try:
        ...
        print(str(e))
        return
    m.edit("🔎 𝐅𝐢𝐧𝐝𝐢𝐧𝐠 𝐀 𝐒𝐨𝐧𝐠 🎶 𝐏𝐥𝐞𝐚𝐬𝐞 𝐖𝐚𝐢𝐭.....")
    try:
        ...
        m.edit('❌ 𝐄𝐫𝐫𝐨𝐫\n\n Report This Erorr To Fix @EmoBotDevolopers ❤️')
        print(e)
    try:
